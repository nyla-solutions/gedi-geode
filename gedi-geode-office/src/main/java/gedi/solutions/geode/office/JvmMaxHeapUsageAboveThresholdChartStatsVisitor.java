 ...
 *
 */
public class JvmMaxHeapUsageAboveThresholdChartStatsVisitor implements  ChartStatsVisitor
{
	...
	public void visitResourceInst(ResourceInst resourceInst)
	{
		...
		double usedMemory = usedMemoryStatValue.getSnapshotsMaximum()/(1073741824);
